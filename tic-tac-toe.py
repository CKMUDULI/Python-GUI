...
def check_wnr():
    if (
        (records[1] == records[2] == records[3] == "X")
        or (records[4] == records[5] == records[6] == "X")
        or (records[7] == records[8] == records[9] == "X")
        or (records[1] == records[4] == records[7] == "X")
        or (records[2] == records[5] == records[8] == "X")
        or (records[3] == records[6] == records[9] == "X")
        or (records[1] == records[5] == records[9] == "X")
        or (records[3] == records[5] == records[7] == "X")
    ):
        main_label.config(text="X wins")
        return True
    elif (
        (records[1] == records[2] == records[3] == "O")
        or (records[4] == records[5] == records[6] == "O")
        or (records[7] == records[8] == records[9] == "O")
        or (records[1] == records[4] == records[7] == "O")
        or (records[2] == records[5] == records[8] == "O")
        or (records[3] == records[6] == records[9] == "O")
        or (records[1] == records[5] == records[9] == "O")
        or (records[3] == records[5] == records[7] == "O")
    ):
        main_label.config(text="O wins")
        return True
    elif "" not in records.values():
